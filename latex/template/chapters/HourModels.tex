...
\noindent The different step responses for the houses are illustrated in 
...
\begin{figure}
    ...
    \caption{The temperature estimates from the regression models compared to the temperature step response for the Marima models without Fourier series. The regression model on the daily data is far superior}
    \label{fig:HCL}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{../../../figures/MariamaHCLF.eps}
    \caption{The temperature estimates from the regression models compared to the temperature step response for the Marima models with Fourier series. There Fourier series does not improve the step response}
    \label{fig:HCLF}
\end{figure}
