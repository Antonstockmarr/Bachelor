...
It has been mentioned earlier that \texttt{MARIMA} works in a fundamentally different way than the \texttt{arima} function. It uses an iterative method to estimate the parameters, including all the regression variables. The exact procedure can be seen in \cite{marima}
