...
{\centering
    \includegraphics[scale=0.85]{../../../figures/Heatmap_winter.eps}
    \captionof{figure}{This figure shows the same as \cref{fig: daily_cons}, but only in the winter period, characterized by an outside temperature below 12 degrees
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{../../../figures/StepResponse.pdf}
    \caption{}
