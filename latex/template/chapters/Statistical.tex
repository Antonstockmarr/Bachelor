...
\noindent In addition, \cref{tab: shapiro_simple_lm} shows the p-values from the Shapiro-Wilk test and it is clear that the majority of the simple models have residuals where the p-value is above the significance level. \textcolor{blue}{Model assumptions kan ikke sige at være opfyldt, når de ikke er opfyldt i størstedelen af tilfældene}
