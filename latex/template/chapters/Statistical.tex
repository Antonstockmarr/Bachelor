...
\noindent The wind directed from East and West also have great influence on the consumption of most houses. \textcolor{red}{Anton og Finn bygger videre på dette med inddragelse af plots.} 
\begin{table}
    \centering
...
\end{figure}
\noindent \textcolor{red}{Kommentarer til predictions.}

\section{Comparison}
When looking at the results of the different tests in \cref{tab: shapiro_simple_lm}-\ref{tab: shapiro_multiple_lm}, the simple model passes the tests in more cases than the multiple model. 
