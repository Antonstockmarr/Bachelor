...
\textcolor{red}{Der hvor der mangler data har vi udregnet dem ved interpolation som givet i det der paper fra Anders. For at kunne lave tidsrække modeller, må der ikke være NA's i data}
