...
\begin{itemize}
    \item \textbf{Ida:} Kigger videre på multiple lm
    \item \textbf{Finn:} 
    \item \textbf{Anton:}
...
\subsection{Spørgsmål}
\begin{itemize}
    \item Hvor finder vi konstanterne til at vægte de forskellige vindretninger?
    \item Hvilken måde skal vi modellere over data der har forskellige længder? Der er nogle der ikke har winter og spring med? 
\end{itemize}
