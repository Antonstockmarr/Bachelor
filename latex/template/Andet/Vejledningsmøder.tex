...
\begin{itemize}
    ...
    \item Giver det mening at lave lm over gennemsnitlig data i forhold til at se på en systematisk måde, hvilke timeintervaller der rent faktisk er signifikante (se heatmaps)?
    \item Hjælp til at farve WindDirection plots. Enorm meget gul farve, som det ser ud nu. 
    ...
    \item Højst sandsynligt ændre på dagsværdierne.
    \item Brændeovn? 
\end{itemize} 
